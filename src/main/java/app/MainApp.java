...
public class MainApp {
    public static void main(String[] args) {
        ...
        LibraryService lib = new LibraryService(bookRepo, userRepo, loanRepo, billing, notify, librarianRepo);

        // örnek başlangıç verisi
        Author a1 = new Author(1, "Yalçın Küçük");
        Category c1 = new Category(1, "Araştırma");
        Book bk1 = lib.addBook("Türkiye Üzerine Tezler", a1, c1, 50.0, "978-605-298-123-4");
        Person m1 = lib.addMember("Lucy", "lucy@example.com", 10121323434L);
        ...
        while (true) {
            ...
            System.out.println("10) Tüm üyeleri listele");
            System.out.println("11) Ödünç verilen tüm kitapları listele");
            System.out.println("12) Kütüphaneci ekle");
            System.out.println("13) Tüm kütüphanecileri listele");
            ...
            try {
                switch (choice) {
                    case "1":
                        ...
                        Book nb = lib.addBook(title, author, cat, price, isbn);
                    ...
                    case "5":
                        ...
                        System.out.print("Personel ID: "); int upersonId = Integer.parseInt(sc.nextLine());
                        Member nm = lib.addMember(uname, uemail, upersonId);
                    ...
                    case "10":
                        ...
                        for (Person p : userRepo.getAll()) System.out.println(p);
                        break;
                    case "11":
                        System.out.print("Ödünç verilen tüm kitaplar:\n");
                        for (Loan loan : loanRepo.getAllActive()) {
                    ...
                    case "13":
                        ...
                        if(librarianRepo.getAll().isEmpty()) System.out.println("Kütüphaneci yok.");
                        for (Librarian libn : librarianRepo.getAll()) {
                            System.out.println(libn);
                        }
                        break;
                    case "0":
